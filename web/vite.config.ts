...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Browser Canary e2e-create-mu1ny9xt-w40108-test",
        short_name: "Browser Canary e2e-create-mu1ny9xt-w40108-test",
        description: "Browser Canary e2e-create-mu1ny9xt-w40108-test — free forever",
        start_url: "/",
        display: "standalone",
